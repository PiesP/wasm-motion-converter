 ...
 * FFmpeg Worker (stub)
 *
 * This worker is intentionally minimal for now.
 * The main-thread FFmpeg service is still used elsewhere in the app.
 *
      ...
      case 'encode': {
        const response: WorkerResponse = {
          ...
          payload: {
            ...
            error: {
              message: 'ffmpeg.worker.ts is not implemented yet.',
