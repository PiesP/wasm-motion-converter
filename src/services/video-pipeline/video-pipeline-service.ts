...
export class VideoPipelineService {
  ...
  static getInstance(): VideoPipelineService {
    VideoPipelineService.instance ??= new VideoPipelineService();
    return VideoPipelineService.instance;
  }
...
export const videoPipelineService = VideoPipelineService.getInstance();
