    ...
    try {
      ...
      try {
        try {
          ...
          const wasCancelled =
            this.cancellationRequested || deps.shouldCancel?.() === true;
          const wasTerminated = errorMsg.includes("called FFmpeg.terminate()");
      ...
      try {
        ...
        const wasCancelled =
          errorMessage.includes("Conversion cancelled by user") ||
