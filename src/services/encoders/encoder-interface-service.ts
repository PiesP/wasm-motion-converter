...
type EncoderProgressCallback = (current: number, total: number) => void;

type EncoderShouldCancel = () => boolean;

type EncoderEnvironment = 'main' | 'worker';
...
export interface EncoderRequest {
  ...
  shouldCancel?: EncoderShouldCancel;
}
